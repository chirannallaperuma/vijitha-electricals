...
<head>
    ...
    <title>VIJITHA|ELECTRCALS</title>
    ...
    <!-- Main Header -->
        <header class="main-header">
            ...
            <a href="#" class="logo">
                ...
                <span class="logo-mini font-weight-bold"><b>V</b>E</span>
                <!-- logo for regular state and mobile devices -->
                <span class="logo-lg text-black font-weight-bold"><b>VIJITHA </b>ELECTRICALS</span>
            </a>
        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu" data-widget="tree" id="sm">
                    ...
                    <li class="active font-weight-bold"><a href="/user"><i class="fa fa-user"></i>
                            <span>User</span></a></li>
        ...
        <footer class="main-footer">
            ...
            <!-- Default to the left -->
            <strong>Copyright &copy; 2019 <a href="#">Vijitha Electricals(PVT) LTD</a>.</strong> All rights reserved.
        </footer>
