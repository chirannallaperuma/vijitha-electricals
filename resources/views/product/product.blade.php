...
@section('content')
    <div class="container-fluid small" ng-app="productApp" ng-controller="productCtrl">
        <form action="/product/save" method="post" enctype="multipart/form-data">
            @csrf
            <div class="card">
                <div class="card-header">
                    <div class="card-title text-info text-uppercase">Product Create
                        <a href="/product/list" target="_self">
                            <button type="button" class="btn btn-success btn-sm float-right "><i class="fa fa-list">
                                    Product List</i>
                            </button>
                        </a>
                    </div>
