...
<head>
    ...
    <title>VIJITHA ELECTRICALS</title>
...
<div class="flex-center position-ref full-height">
    ...
    <div class="limiter">
        <div class="container-login100" style="background-image: url('{{ asset('template/images/img-01.jpg') }}');">
            <div class="wrap-login100 p-t-190 p-b-30">
                <form method="POST" action="{{ route('login') }}">
                    @csrf
                    <!-- <div class="login100-form-avatar">
                        <img src="{{ asset('template/images/logo.svg') }}" alt="AVATAR">
                    </div> -->
